...
```bash
ls skills/deepppt/templates/icons/chunk-filled/ | grep home
ls skills/deepppt/templates/icons/tabler-filled/ | grep home
ls skills/deepppt/templates/icons/tabler-outline/ | grep chart
ls skills/deepppt/templates/icons/phosphor-duotone/ | grep house
ls skills/deepppt/templates/icons/simple-icons/ | grep github
```
