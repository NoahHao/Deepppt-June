...
```bash
python3 skills/deepppt/scripts/image_gen.py \
    --manifest skills/deepppt/references/ai-image-comparison/rendering/_manifest.json \
    -o skills/deepppt/references/ai-image-comparison/rendering/ \
    --backend openai

python3 skills/deepppt/scripts/image_gen.py \
    --manifest skills/deepppt/references/ai-image-comparison/palette/_manifest.json \
    -o skills/deepppt/references/ai-image-comparison/palette/ \
    --backend openai

python3 skills/deepppt/scripts/image_gen.py \
    --manifest skills/deepppt/references/ai-image-comparison/type/_manifest.json \
    -o skills/deepppt/references/ai-image-comparison/type/ \
    --backend openai
```
