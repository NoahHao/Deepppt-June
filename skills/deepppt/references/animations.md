...
Executors should wrap logical sections in `<g id>` regardless of whether you plan to animate. The Executor reference (`skills/deepppt/references/shared-standards.md`) requires it.
