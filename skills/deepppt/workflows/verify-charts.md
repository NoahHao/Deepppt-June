...
5. Run the matching calculator command:
   ...
   python3 skills/deepppt/scripts/svg_position_calculator.py calc bar \
   ...
   python3 skills/deepppt/scripts/svg_position_calculator.py calc line \
   ...
   python3 skills/deepppt/scripts/svg_position_calculator.py calc pie \
   ...
   python3 skills/deepppt/scripts/svg_position_calculator.py calc radar \
