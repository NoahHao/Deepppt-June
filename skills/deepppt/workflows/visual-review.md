...
python3 skills/deepppt/scripts/svg_editor/server.py <project_path> --no-browser
...
```bash
python3 skills/deepppt/scripts/visual_review.py <project_path>
```
...
- Path to the rubric: `skills/deepppt/references/visual-review.md`
