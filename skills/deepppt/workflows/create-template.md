...
```bash
python3 skills/deepppt/scripts/pptx_template_import.py "<reference_template.pptx>"
```
...
```bash
mkdir -p "skills/deepppt/templates/layouts/<template_id>"
```

> **Output location**: Global templates go to `skills/deepppt/templates/layouts/`; project templates go to `projects/<project>/templates/`
>
...
ls -la "skills/deepppt/templates/<kind_dir>/<template_id>"
```

Run SVG validation on the template directory:

```bash
python3 skills/deepppt/scripts/svg_quality_checker.py "skills/deepppt/templates/<kind_dir>/<template_id>" --template-mode --format <canvas_format>
```
...
```bash
# For deck (default)
python3 skills/deepppt/scripts/register_template.py <template_id> --kind deck

# For layout
python3 skills/deepppt/scripts/register_template.py <template_id> --kind layout
```
...
>
> ```bash
> python3 skills/deepppt/scripts/register_template.py --kind deck --rebuild-all
> python3 skills/deepppt/scripts/register_template.py --kind layout --rebuild-all
> ```
