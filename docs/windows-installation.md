...
1. Go to [github.com/&lt;repo&gt;/deepppt](https://github.com/&lt;repo&gt;/deepppt)
2. Click the green **Code** button → **Download ZIP**
3. Unzip to `C:\Users\YourName\deepppt`

**Option B — Git Clone** (requires [Git](https://git-scm.com/downloads)):

```powershell
git clone https://github.com/&lt;repo&gt;/deepppt.git
cd deepppt
```
...
```powershell
cd C:\Users\YourName\deepppt   # ← adjust to your actual path
...
Open your AI editor (Cursor, VS Code + Copilot, etc.), open the `deepppt` folder, and type in the chat:
...
- 📖 [FAQ](./faq.md)
- 🐛 [GitHub Issues](https://github.com/&lt;repo&gt;/deepppt/issues) — include your Python version, Windows version, and full error message
- 💬 [GitHub Discussions](https://github.com/&lt;repo&gt;/deepppt/discussions)
