...
```bash
python3 skills/deepppt/scripts/svg_to_pptx.py <project_path> --merge-paragraphs
```
...
```bash
python3 skills/deepppt/scripts/svg_to_pptx.py <project> -t push       # different transition
python3 skills/deepppt/scripts/svg_to_pptx.py <project> -t none       # disable transitions
python3 skills/deepppt/scripts/svg_to_pptx.py <project> -a none       # disable per-element animation
python3 skills/deepppt/scripts/svg_to_pptx.py <project> --animation fade        # use a single effect instead of mixed
python3 skills/deepppt/scripts/svg_to_pptx.py <project> --animation-trigger on-click   # presenter-paced reveals
```
...
Full effect list, anchor logic (top-level `<g id="...">`), fallback behavior, and limitations: see [Animations & Transitions](../skills/deepppt/references/animations.md).
...
> For more questions, see [SKILL.md](../skills/deepppt/SKILL.md) and [AGENTS.md](../AGENTS.md)
