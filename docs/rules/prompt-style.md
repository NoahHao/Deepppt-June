...
> Style rules for files under `skills/deepppt/references/`. Follow these when writing or reviewing role definitions and shared specs.
...
|---|---|
| A role reference (Image_X / Strategist-style) | [`image-searcher.md`](../skills/deepppt/references/image-searcher.md), [`strategist.md`](../skills/deepppt/references/strategist.md) |
| A shared spec across roles | [`image-base.md`](../skills/deepppt/references/image-base.md), [`shared-standards.md`](../skills/deepppt/references/shared-standards.md) |
| A technical / format spec | [`canvas-formats.md`](../skills/deepppt/references/canvas-formats.md), [`svg-image-embedding.md`](../skills/deepppt/references/svg-image-embedding.md), [`image-layout-spec.md`](../skills/deepppt/references/image-layout-spec.md) |
| Workflow runbook | [`workflows/verify-charts.md`](../skills/deepppt/workflows/verify-charts.md) |
