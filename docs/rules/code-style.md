...
> Style rules for Python code under `skills/deepppt/scripts/` and any Python that ships with the skill. Derived from the de facto patterns in the existing codebase.
...
| Module | Owns |
|---|---|
| [`image_backends/backend_common.py`](../skills/deepppt/scripts/image_backends/backend_common.py) | HTTP download, retry, image format detection, save-with-Pillow-transcode |
| [`image_sources/provider_common.py`](../skills/deepppt/scripts/image_sources/provider_common.py) | License classification, query simplification, scoring, attribution text, dataclasses |
| [`project_utils.py`](../skills/deepppt/scripts/project_utils.py) | Canvas formats, project path conventions |
| [`error_helper.py`](../skills/deepppt/scripts/error_helper.py) | User-facing error message templates |
...
|---|---|
| A small CLI utility | [`total_md_split.py`](../skills/deepppt/scripts/total_md_split.py), [`gemini_watermark_remover.py`](../skills/deepppt/scripts/gemini_watermark_remover.py) |
| A multi-backend / dispatcher CLI | [`image_search.py`](../skills/deepppt/scripts/image_search.py), [`image_gen.py`](../skills/deepppt/scripts/image_gen.py) |
| A library / shared helper | [`image_sources/provider_common.py`](../skills/deepppt/scripts/image_sources/provider_common.py), [`image_backends/backend_common.py`](../skills/deepppt/scripts/image_backends/backend_common.py) |
| A class-based checker / validator | [`svg_quality_checker.py`](../skills/deepppt/scripts/svg_quality_checker.py) |
