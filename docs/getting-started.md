...
| Location | Path | Notes |
|---|---|---|
| **Registered in the skill library** | `skills/deepppt/templates/layouts/<id>/` | Global, reusable across every project; run `register_template.py` so it shows up when you ask "what templates are available?" |
...
```
You: Make a deck from sources/report.pdf with template skills/deepppt/templates/layouts/academic_defense/
```
...
PPT Master was chat-only by design; visual editing was folded in after enough users asked for it (built on [@WodenJay](https://github.com/WodenJay)'s [PR #85](https://github.com/&lt;repo&gt;/deepppt/pull/85)).

Full guide → [Live Preview Workflow](../skills/deepppt/workflows/live-preview.md)
...
Full guide → [Animations & Transitions](../skills/deepppt/references/animations.md)
...
|---|---|
| The AI drifts or forgets a step | Ask it to re-read `skills/deepppt/SKILL.md`. |
