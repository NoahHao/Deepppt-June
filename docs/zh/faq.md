...
```bash
python3 skills/deepppt/scripts/svg_to_pptx.py <project> -t push       # 换转场效果
python3 skills/deepppt/scripts/svg_to_pptx.py <project> -t none       # 关闭转场
python3 skills/deepppt/scripts/svg_to_pptx.py <project> -a none       # 关闭页内动画
python3 skills/deepppt/scripts/svg_to_pptx.py <project> --animation fade        # 改用单一效果（仍是默认级联）
python3 skills/deepppt/scripts/svg_to_pptx.py <project> --animation-trigger on-click   # 改为单击触发，演讲者控制节奏
```
...
> 更多问题可先查看 [skills/deepppt/SKILL.md](../../skills/deepppt/SKILL.md) 与 [AGENTS.md](../../AGENTS.md)
