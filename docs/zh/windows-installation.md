...
1. 打开 [GitHub](https://github.com/&lt;repo&gt;/deepppt)（或 [AtomGit 镜像](https://atomgit.com/&lt;repo&gt;/deepppt)，国内更快）
2. 点击绿色 **Code** 按钮 → **Download ZIP**
3. 解压到 `C:\Users\你的用户名\deepppt`
...
# AtomGit（国内更快）
git clone https://atomgit.com/&lt;repo&gt;/deepppt.git
cd deepppt
```
...
```powershell
cd C:\Users\你的用户名\deepppt   # ← 替换为你的实际路径
...
打开你的 AI 编辑器（Cursor、VS Code + Copilot 等），打开 `deepppt` 目录，在聊天面板输入：
...
- 📖 [常见问题 (FAQ)](./faq.md)
- 🐛 [GitHub Issues](https://github.com/&lt;repo&gt;/deepppt/issues) — 附上 Python 版本、Windows 版本和完整报错
