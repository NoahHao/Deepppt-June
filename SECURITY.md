...
If you discover a security issue, please report it through the project's issue tracker (use a private channel if available).
...
- Python scripts in `skills/deepppt/scripts/`
