...
Deepppt，一个针对企业牛马的ppt写作工作，主要提供PPT召回以及PPT生成的问题。一个找，一个写。
...
======== 分割线 ======== 如果这一步测试都没看到预期的效果，也不用往下看了============================分割线 ===============

## 产品设计原则 读书人的事儿，能叫抄么？
1. 把存量的知识用好比什么都强：天下文章一大抄，无论是这个skill还是PPT。有人写过的东西绝对不自己动手，对ppt格式部分的项目已经很多了，就直接复用PPT-Master。PPT已经有人写过了，那就直接拿过来改改。
